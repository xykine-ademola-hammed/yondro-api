...
exports.SchoolOrOfficeSeeder = exports.schoolOfficeDepartentUnits = void 0;
const models_1 = require("../models");
exports.schoolOfficeDepartentUnits = [
    {
...
const rows = exports.schoolOfficeDepartentUnits.map((data) => ({
    name: data.name,
    financeCode: data.financeCode,
    organizationId: 1,
    isActive: true,
}));
class SchoolOrOfficeSeeder {
    static async run() {
        await models_1.SchoolOrOffice.bulkCreate(rows, {
            ignoreDuplicates: true,
        });
    }
}
exports.SchoolOrOfficeSeeder = SchoolOrOfficeSeeder;
//# sourceMappingURL=20250823-full-schoolOrOffices.seeder.js.map